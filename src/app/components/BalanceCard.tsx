...
function BalanceCard() {
    return (
        ...
        <div className="w-full sm:w-10/12 md:w-8/12 lg:w-[450px] lg:h-[706px] h-auto border border-gray-100 rounded-xl p-2 mx-auto">
            <div className="w-11/12 mx-auto p-4 bg-[#F1F68E] rounded-xl mt-5">
                <div className="rounded-2xl p-4 bg-white mt-5 flex flex-col sm:flex-row items-center sm:justify-center gap-4 sm:gap-2">
                    ...
                    <div className="text-center sm:text-left">
                        ...
                        <h2 className="text-xl sm:text-2xl lg:text-2xl font-roboto font-bold">Maria kosta</h2>
                        <p className="font-semibold text-[#686868] text-sm">Maria@mail.com</p>
                    </div>
                    <h1 className="text-xl sm:text-2xl lg:text-2xl font-bold text-[#0F4E23] sm:ml-auto font-roboto mt-2 sm:mt-0">
                        +$10K
                    </h1>
                </div>
                ...
                <div className="bg-white rounded-2xl mt-5 p-4">
                    <div className="flex flex-col sm:flex-row items-center justify-between">
                        <div className="text-center sm:text-left">
                            ...
                            <h1 className="font-semibold text-lg sm:text-xl lg:text-xl font-roboto sm:mt-10">$12000.00</h1>
                        </div>

                        <div className="sm:mt-0 sm:pl-10 text-center sm:text-left">

                            <p className="w-12 sm:w-12 lg:w-16 rounded-full bg-[#F1F68E] p-3 text-green-700 font-bold text-sm font-roboto mx-auto sm:mx-0 sm:mb-10">
                                10%
                            </p>
